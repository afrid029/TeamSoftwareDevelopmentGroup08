          ...
          <div class="container">
               ...
               <div style="background-color:#154360 " class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li><a href="{{route('Ingstock',$c->Pro_id)}}" class="smoothScroll"><font color="red">Ingredients Stock</font></a></li>
                    ...
                    <div class="caption">
                         ...
                         <div style="background-color:white;border-radius:8%; width:86.4%; margin:-12% 7% 0 7.8%; padding-left:1%;">
                              ...
                              <div style="overflow-y:scroll; position:relative; display:block; height:150px;">
                                        ...
                                        <h3 style = "color: grey;">All ingredients are upto date</h3>
                                  

                                   
                                        <h3 style = "color: grey;">All ingredient stocks are available</h3>
