     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li><a href="{{route('ingordering',$c->Sup_id)}}" class="smoothScroll"><font color="red">Ingredients Orderings</font></a></li>
                                                  ...
                                                  <div style="width:50%; margin-right: -20%; float:left; margin-left:2%;"><h2>Orders</h2></div>
                                                       <div class="table-title">
                                                            <div style="margin-top:2%; margin-right:2%;color:gray; width:20%; float:left;">
                                                                 <input class="form-control" type="text" id="myInput" onkeyup="myFunction()" placeholder="Search Order By Producer ID" title="Type ID">   
                                                            </div>
                                                            <input style="margin-top:2%; width: 20%; float:left;"  class="form-control" type="Date" id="myInput1" onkeyup="myFunction1()" title="Type Date">
                                                       </div>
                                                            ...
                                                            <tbody class="body-half-screen">
                                                                 ...
                                                                 <tr>
                                                                      ...
                                                                      <input type="hidden" id = "idr" value="">
                                                                           ...
                                                                           <button data-toggle="modal" class = "btn btn-primary btn-sm">View</button>&nbsp;<a href="" class = "btn btn-danger btn-sm">Send</a>
                                                                      </td>
                                                                 </tr>
                                                            
                                                                 <tr>
                                                                      <td colspan="8"><h3 style=" color:black;text-align: center; font-size:20px;">There are no orders</h3></td>
                                                                 </tr>
