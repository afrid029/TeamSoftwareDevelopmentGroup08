...
if (typeof usi_commons === 'undefined') {
	usi_commons = {
		...
		load:function(usiHash, usiSiteID, usiKey, callback){
			...
			var source = this.domain + "/usi_load2.jsp?hash=" + usiHash + "&siteID=" + usiSiteID + "&keys=" + usiKey + usi_append;
			this.load_script(source, callback);
		},
